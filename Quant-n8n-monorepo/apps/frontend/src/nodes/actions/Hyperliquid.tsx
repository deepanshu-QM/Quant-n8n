...
/*import { SUPPORTED_ASSETS } from "@/components/TriggerSheet";   this is older One before common type*/
/*
            ...
            <div className="relative flex flex-col gap-2 px-3 py-2 min-w-[160px]">
                ...
                <div className="flex items-center justify-between gap-2">
                    ...
                    <span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full ${
                        ...
                        {isLong ? <TrendingUp size={10} className="inline mr-0.5" /> : <TrendingDown size={10} className="inline mr-0.5" />}
                        {data.metadata.type}
                    </span>
                </div>
